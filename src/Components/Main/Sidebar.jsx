         ...
         <aside class="block  md:hidden sm:hidden top-0 left-0 z-40 w-64 h-screen transition-transform  sm:translate-x-0" >
            <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
               <ul class="space-y-2 font-medium">
                  ...
                  <li onClick={() => navigate("/home/recharge")} className="cursor-pointer">
                     <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                  ...
                  <li onClick={() => navigate("/home/withdraw")} className="cursor-pointer">
                     <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                  ...
                  <li onClick={() => navigate("/home/transfer")} className="cursor-pointer">
                     <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                  ...
                  <li onClick={() => navigate("/home/about")} className="cursor-pointer">
                     <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                  ...
                  <li onClick={() => navigate("/home/partners")} className="cursor-pointer">
