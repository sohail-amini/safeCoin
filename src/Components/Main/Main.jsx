    ...
    <div>
      ...
      <div className="mt-4 grid grid-cols-3 gap-x-2 md:grid-cols-2 sm:grid-cols-2 gap-y-2">
        <a onClick={() => navigate("/home/recharge")}
          href="#" className="flex md:flex-col sm:flex-col sm:items-center  items-cener block space-x-3 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700  ">
          <BanknotesIcon className="text-blue-500 h-12 w-12" />
          <h5 className="mb-2 flex items-center text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Recharge</h5>
          {/* <p className="font-normal text-gray-700 dark:text-gray-400">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.</p> */}
        </a>
        <a onClick={() => navigate("/home/withdraw")} href="#" className="flex md:flex-col sm:flex-col sm:items-center items-cener block space-x-3 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700  ">
          <GiWallet className="dark:text-cyan-100 text-black h-12 w-12" />
          <h5 className="mb-2 flex items-center text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Withdraw</h5>
          {/* <p class="font-normal text-gray-700 dark:text-gray-400">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.</p> */}
        </a>
        <a onClick={() => navigate("/home/transfer")} href="#" className="flex md:flex-col sm:flex-col sm:items-center items-cener block space-x-3 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700  ">
