...
export const Deposite = () => {
    ...
    return (
        <div>
            <h2 className="text-2xl ml-3">{localStorage.getItem('username')}, Please Complete Your Investment Deposit</h2>
            <div className="flex">
                <a className="inline bg-red-500" >
                    <img src={`https://www.bitcoinqrcodemaker.com/api/?style=bitcoin&address=${depositeInfo.address}&amount=30&color=1`} />
                </a>
                <div className="mt-10">
