...
export const Invest = (props) => {
  ...
  return (
    <div className="w-full">
      ...
      {pendingTransferInfo && (
        <div
          className="text-base p-4 my-4  h-24 text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400"
          role="alert"
        >
            ...
            <a
              onClick={() =>
                navigate("/home/deposite", {
                  state: { last_route: "invest", productId: pck.product_id },
                })
              }
